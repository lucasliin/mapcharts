...
function getMouseInfo(event: MouseEvent): {
  ...
  if (target && target instanceof HTMLElement) {
    const tableDOMNode = target.closest<HTMLElement>(
      "td.lexicaltheme__tableCell, th.lexicaltheme__tableCell"
    );

    const isOutside = !(
      tableDOMNode ||
      target.closest<HTMLElement>("button.lexicaltheme__tableAddRows") ||
      target.closest<HTMLElement>("button.lexicaltheme__tableAddColumns") ||
